...
Markdown plugin for Sublime Text. Provides a decent Markdown color scheme (light and dark) with more __robust__ syntax highlighting and useful 192.168.20.64:8080/ecodeClient/getGeneralBackByLogin/userName=测试生产机/password=123qwe/pageNum=1/pageSize=12Markdown editing features for Sublime Text. 3 flavors are supported: Standard Markdown, __GitHub flavored Markdown__, MultiMarkdown.
